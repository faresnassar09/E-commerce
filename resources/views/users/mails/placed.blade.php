...
<body style="font-family: sans-serif; background-color: #f9fafb; padding: 20px; color: #333;">
    ...
    <div style="max-width: 600px; margin: auto; background-color: #ffffff; padding: 30px; border-radius: 10px; box-shadow: 0 2px 8px rgba(0,0,0,0.05);">
        ...
        <h2 style="color: #16a34a; font-size: 24px;">✅ شكراً يا {{ $userInfo['name'] }}، تم تأكيد طلبك!</h2>
        <h2 style="color: #16a34a; font-size: 24px;">✅  عنوان {{ $userInfo['city'] .'/'.$userInfo['area'].'/'.$userInfo['street']}} </h2>
        <h2 style="color: #16a34a; font-size: 24px;">✅  رقم البائع {{ $sellerPhoneNumber}} </h2>
