...
@section('title', __('messages.canceled_orders_title'))
@section('content')

<div class="container mx-auto p-4 max-w-6xl">
    <h2 class="text-2xl font-bold mb-6 text-red-600">{{__('messages.canceled_orders_heading')}}</h2>
    ...
    @empty
    <div class="text-center text-gray-500 mt-12 text-lg">{{__('messages.no_canceled_orders')}}</div>
    @endforelse
</div>
