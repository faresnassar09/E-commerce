...
<button wire:click="trackOrder($id)" class="bg-blue-600 text-white px-3 py-1 rounded hover:bg-green-700">تتبع</button>
          <button wire:click="cancel({{ $this->id }})" class="bg-red-500 text-white px-3 py-1 rounded hover:bg-yellow-600">إلغاء</button>
