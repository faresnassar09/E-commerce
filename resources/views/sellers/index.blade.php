...
<head>
    ...
    <title>قسم البائعين - فضائي</title>
...
<body>
    ...
    <main class="flex items-center justify-center min-h-screen relative z-10 px-4">
        <div class="neon-box rounded-3xl p-10 max-w-lg w-full text-center space-y-6 animate-fade-in">
            <h2 class="text-4xl font-extrabold glow">مرحبًا بك في قسم البائعين 👽</h2>

            <p class="text-gray-300 text-base">
                عندك منتجات جامدة؟ 🛸 <br>
                شاركها على منصتنا وخلي الفضاء كله يعرفها 🌌
            </p>

            <p class="text-gray-300 text-base">
                معانا الأدوات اللي هتخلي مشروعك يطير بسرعه الصاروخ 🚀
            </p>
