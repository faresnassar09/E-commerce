...
<body style="font-family: sans-serif; background-color: #f9fafb; padding: 20px; color: #333;">
    ...
    <div style="max-width: 600px; margin: auto; background-color: #ffffff; padding: 30px; border-radius: 10px; box-shadow: 0 2px 8px rgba(0,0,0,0.05);">
        <h2 style="color: #16a34a; font-size: 24px;">✅ تم توصيل الطلب</h2>

        <p style="font-size: 16px;">نود إعلامك أنه تم توصيل الطلب رقم <strong>#{{ $orderDetails['order_number'] }}</strong> بنجاح إلى العميل.</p>
        ...
        <h3 style="margin-top: 30px; font-size: 18px;">🛒 المنتجات التي تم توصيلها:</h3>
        ...
        <p style="margin-top: 30px;">نشكرك على استخدامك منصتنا، ونتمنى لك دوام النجاح في مبيعاتك 🚚📦</p>
    </div>
