...
<body style="font-family: sans-serif; background-color: #f9fafb; padding: 20px; color: #333;">
    ...
    <h2 style="color: #16a34a; font-size: 24px;">✅ {{ 'طلب جديد ' }}</h2>

        <h2 style="color: #16a34a; font-size: 24px;">    اسم العميل:: {{ $user['name'] }}</h2>
        <h2 style="color: #16a34a; font-size: 24px;">  عنوان {{ $user['city'] .'/'.$user['area'].'/'.$user['street']}} </h2>
        <h2 style="color: #16a34a; font-size: 24px;">  رقم العميل {{ $user['phone']}} </h2>
